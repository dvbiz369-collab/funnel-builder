export default function PhoneFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative h-[700px] w-[346px] shrink-0 rounded-[44px] border-[10px] border-zinc-900 bg-zinc-900 shadow-[0_24px_60px_-20px_rgba(0,0,0,0.45)] dark:ring-1 dark:ring-white/15">
